...
function LuminaDiscoverySection() {
  ...
  const templates = [
    { title: "Horizon Dashboard", tag: "Productivity", image: "/images/templates/TemplatePage1.png", desc: "A high-performance analytics dashboard designed for complex data visualization. Features include real-time metrics, interactive charts, and a glassmorphic sidebar layout." },
    { title: "Arc Portfolio", tag: "Creative", image: "/images/templates/minimal_mockup_1_new.png", desc: "A minimalist creative portfolio focusing on high-impact typography and smooth scroll transitions. Ideal for photographers, designers, and digital artists." },
    { title: "Lumina Marketing", tag: "Showcase", image: "/images/templates/featured_v1.png", desc: "Our flagship marketing landing page. Engineered with physics-based motion and premium layout systems to drive conversions through aesthetic excellence." },
    { title: "Vault Docs", tag: "Technical", image: "/images/templates/TemplatePage3.png", desc: "A technical documentation template that balances readability with technical sophistication. Includes a multi-level sidebar and search-first navigation." },
    { title: "Nova UI Kit", tag: "Interface", image: "/images/templates/pro_2.png", desc: "A comprehensive UI component library showcase. Designed with atomic design principles to ensure consistency across every visual element." }
  ];
